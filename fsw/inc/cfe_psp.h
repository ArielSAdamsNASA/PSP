...
/** \name Reset Types */
/** \{ */
#define CFE_PSP_RST_TYPE_PROCESSOR \
    1 /**< Volatile disk, Critical Data Store and User Reserved memory could still be valid */
...
#define CFE_PSP_RST_SUBTYPE_PUSH_BUTTON                                          \
    2 /**< \brief  Reset caused by reset button on the board having been pressed \
       */
#define CFE_PSP_RST_SUBTYPE_HW_SPECIAL_COMMAND \
    3 /**< \brief  Reset was caused by a reset line having been stimulated by a hardware special command */
#define CFE_PSP_RST_SUBTYPE_HW_WATCHDOG 4 /**< \brief  Reset was caused by a watchdog timer expiring */
#define CFE_PSP_RST_SUBTYPE_RESET_COMMAND \
    5 /**< \brief  Reset was caused by cFE ES processing a \link #CFE_ES_RESTART_CC Reset Command \endlink */
...
#define CFE_PSP_RST_SUBTYPE_BANKSWITCH_RESET                                 \
    9 /**< \brief  Reset reverted to a cFE POWERON due to a boot bank switch \
       */
#define CFE_PSP_RST_SUBTYPE_MAX \
    10 /**< \brief  Placeholder to indicate 1+ the maximum value that the PSP will ever use. */
/** \} */
